...
function site_scripts() {
	...
	// fontawesome
	wp_enqueue_script( 'fontawesome-js', 'https://pro.fontawesome.com/releases/v5.3.1/js/all.js', array(), '', true );
	//  codemirror JS
	...
	//wp_enqueue_script( 'materialze-customnav-js', 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/83206/materialize_sidenav_modified.js', array(), '', true );
