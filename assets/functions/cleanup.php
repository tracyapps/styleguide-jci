...
add_action( 'after_setup_theme', 'start_start', 16 );

function start_start() {

	// launching operation cleanup
	add_action( 'init', 'start_head_cleanup' );
...
function start_get_the_author_posts_link() {
	global $authordata;
	...
	$link = sprintf(
		...
		esc_attr( sprintf( __( 'Posts by %s', 'start' ), get_the_author() ) ),
