<nav class="sidenav" id="left-side-nav" style="transform: translateX(-75%);">
	...
	<ul class="styleguide-sidenav">
		<li class="index">
			<a href="<?php echo "http://" . $_SERVER[ 'SERVER_NAME' ]; ?>/dv/styleguide"><i class="fal fa-home"></i> <span>Styleguide home</span></a>
		</li>
		<li class="fonts">
			<a href="fonts.php"><i class="fal fa-font"></i> <span>Fonts</span></a>
		</li>
		<li class="colors">
			<a href="colors.php"><i class="fal fa-palette"></i> <span>Colors</span></a>
		</li>
		<li class="buttons_tabs">
			<a href="buttons_tabs.php"><i class="fal fa-object-group"></i> <span>Buttons & Tabs</span></a>
		</li>
		<li class="table">
			<a href="table.php"><i class="fal fa-table"></i> <span>Table</span></a>
		</li>
		<li class="table_complex">
			<a href="table_complex.php"><i class="fal fa-newspaper"></i> <span>Complex Table (w/edit)</span></a>
		</li>
		<li class="navigation">
			<a href="navigation.php"><i class="fal fa-bars"></i> <span>Navigation</span></a>
		</li>
		<li class="code">
			<a href="code.php"><i class="fal fa-code"></i> <span>Code standards</span></a>
		</li>
		<li class="back_to_prototype">
			<a href="<?php echo "http://" . $_SERVER[ 'SERVER_NAME' ]; ?>/dv/"><i class="fal fa-backward"></i> <span>back to prototype</span></a>
		</li>
	</ul>
</nav>